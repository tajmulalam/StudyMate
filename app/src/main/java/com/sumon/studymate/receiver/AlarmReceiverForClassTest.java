...
import com.sumon.studymate.service.MyAlarmServiceForClassTest;

/**
 * Created by Md Tajmul Alam Sumon on 11/3/2016.
 */
public class AlarmReceiverForClassTest extends BroadcastReceiver {
...
//        Toast.makeText(context, "Alarm fired", Toast.LENGTH_SHORT).show();
        ...
        Intent service1 = new Intent(context, MyAlarmServiceForClassTest.class);
